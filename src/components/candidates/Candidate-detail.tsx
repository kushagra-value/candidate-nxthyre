  ...
  const mockInterviews: Interview[] = [
    {
      ...
      status: "completed",
      notes:
        "Candidate demonstrated good knowledge of React and Node.js. Could improve on system design concepts.",
      feedback: {
        technicalSkills: 4,
        communication: 3,
        problemSolving: 4,
        ...
        overall: 4,
        comments:
          "Strong technical skills, especially in frontend development. Good problem-solving approach. Communicates ideas clearly but could be more concise.",
      },
    },
    {
      id: "int2",
      ...
      const fetchCandidate = async () => {
        ...
        try {
          ...
          const mappedCandidate: Candidate = {
            ...
            profileImage: doc.profilePicture || 'https://blocks.astratic.com/img/general-img-landscape.png',
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <div className="flex gap-2 ml-64 mb-10">
                      {selectedCandidate.github!=="NA" && (
                        <button
                        onClick={() => handleLinkClick(selectedCandidate.github)}
                      ...
                      {selectedCandidate.portfolio!=="NA" && (
                        <button
                        onClick={() => handleLinkClick(selectedCandidate.portfolio)}
                        className="bg-secondary-100 p-2 rounded-full text-secondary-700 hover:bg-secondary-200"
                        aria-label="Visit LinkedIn profile"
                      >
                          <Globe size={18} />
                      ...
                      <button
                        onClick={() => handleLinkClick(selectedCandidate.linkedIn)}
                        className="bg-secondary-100 p-2 rounded-full text-secondary-700 hover:bg-secondary-200"
                        aria-label="Visit LinkedIn profile"
                      >
                        <Linkedin size={18} />
                      ...
                      {selectedCandidate.kaggle!=="NA" && (
                        <button
                        onClick={() => handleLinkClick(selectedCandidate.kaggle)}
                        className="bg-secondary-100 p-2 rounded-full text-secondary-700 hover:bg-secondary-200"
                        aria-label="Visit LinkedIn profile"
                      >
      ...
      >
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {selectedCandidate.skills.length === 0 ? (
            <p className="text-secondary-600 text-sm">No skills listed</p>
          ) : (
            <>
              {(showAllSkills
                ? selectedCandidate.skills
                : selectedCandidate.skills.slice(0, 15)
              ).map((skill) => (
                <Tag key={skill} label={skill} size="sm" />
              ))}
              {selectedCandidate.skills.length > 15 && (
                <button
                ...
                >
                  {showAllSkills
                    ? "Show Less"
                    : `+${selectedCandidate.skills.length - 15} more skills`}
                </button>
              )}
            </>
          )}
