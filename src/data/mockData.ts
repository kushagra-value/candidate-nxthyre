...
export const skillsOptions = [
  'Machine Learning', 'TypeScript', 'Node.js', 'MongoDB', 'AWS', 'Pytorch', 'React', 'CSS', 'HTML', 'UI/UX', 'TensorFlow', 'Spring Boot', 'Microservices', 'Docker', 'Kubernetes', 'Python', 'Django', 'Flask', 'SQL', 'Data Analysis', 'Angular', 'Vue.js', 'JavaScript', 'Redux', 'Product Management', 'Leadership', 'Strategy', 'Business Development', 'Agile', 'Data Science', 'R', 'Big Data', 'Marketing', 'Digital Marketing', 'SEO', 'SEM', 'Content Strategy', 'DevOps', 'Azure', 'CI/CD', 'Jenkins', 'GraphQL', 'Kafka', 'iOS Development', 'Swift', 'Objective-C', 'Mobile Architecture', 'Hadoop', 'Spark', 'Data Engineering', 'iOS Development', 'Swift', 'Objective-C', 'Mobile Architecture', 'Hadoop', 'Spark', 'Data Engineering', 'Agile', 'Business Development', 'Analytics', 'Market Research', 'UI/UX Design', 'Cloud Computing', 'Cybersecurity', 'Blockchain', 'AR/VR', 'Game Development', 'Robotics', 'Internet of Things (IoT)', 'Quantum Computing', 'Natural Language Processing (NLP)', 'Computer Vision'
];
